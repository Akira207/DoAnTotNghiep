...
export default function MaterialsHistoryActions({ onSearch }) {
  ...
  return (
    <div className="bg-surface-container-lowest p-6 flex flex-col md:flex-row justify-between items-center gap-4 sm:flex-wrap rounded-xl">
      {/* Search */}
      ...
      <div className="flex gap-3 w-full md:w-auto">
        ...
        <button className="flex-1 md:flex-none px-5 py-2.5 bg-primary text-on-primary font-semibold text-sm rounded-lg hover:bg-primary-dim transition-all shadow-lg shadow-primary/20 flex items-center justify-center gap-2">
